<template>
    <form class="card auth-card" @submit.prevent="submitHandler">
        <div class="card-content">
            <span class="card-title">Вход на страницы для содрудников</span>
...
<script>
    ...
    export default {
        ...
        mounted() {
            if (this.$route.query.message === 'vacancies') {
                this.$router.push('/hr/vacancies');
            }
            else if (this.$route.query.message === 'staff') {
